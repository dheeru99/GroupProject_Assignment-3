 ...
 * @author dheer
 */
public class MangeDoctorPortalPanel extends javax.swing.JPanel {

    /**
     * Creates new form MangeDoctorPortalPanel
     */
   JPanel rightLayout;
    DoctorDirectory doctorDirectory;
    PatientDirectory patientDirectory;
    public MangeDoctorPortalPanel(JPanel rightLayout, DoctorDirectory doctorDirectory,PatientDirectory patientDirectory) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
            DoctorPortalPanel doc = new DoctorPortalPanel(rightLayout, doctorDirectory,patientDirectory);
            rightLayout.add("DoctorPortalPanel",doc);
